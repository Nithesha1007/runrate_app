...
import '../data/cfo_mock_repository.dart';
import 'cfo_ai_cubit.dart';
import 'cfo_ai_state.dart';
...
class CfoAiScreen extends StatelessWidget {
 const CfoAiScreen({super.key, this.userName = 'Alex'});

  /// TODO: wire to the logged-in CFO's real first name once available.
  final String userName;
  
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => CfoAiCubit(CfoMockRepository()),
      child: _CfoAiView(userName: userName),
    );
  }
}

class _CfoAiView extends StatefulWidget {
  const _CfoAiView({required this.userName});
  final String userName;

  @override
  State<_CfoAiView> createState() => _CfoAiViewState();
}

class _CfoAiViewState extends State<_CfoAiView> {
  final _textController = TextEditingController();
  final _scrollController = ScrollController();

  void _send(BuildContext context, String text) {
    final cubit = context.read<CfoAiCubit>();
  ...
  Future<void> _pickImage(BuildContext context) async {
    ...
    context.read<CfoAiCubit>().attachFile(result.single.name);
  }
                ...
                children: [
                  Column(
                    children: [
                      _AiHeaderBar(
                        onMenuTap: () =>
                            context.read<CfoAiCubit>().openSidebar(),
                        onNewChat: () =>
                            context.read<CfoAiCubit>().startNewChat(),
                      ),
                      ...
                      Padding(
                        ...
                        child: _AiInputBar(
                          ...
                          onRemoveAttachment: () =>
                              context.read<CfoAiCubit>().removeAttachment(),
                          onMicTap: () =>
                  ...
                  if (state.sidebarOpen)
                    GestureDetector(
                      onTap: () => context.read<CfoAiCubit>().closeSidebar(),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: _ScaleOnTap(
                  onTap: () => context.read<CfoAiCubit>().startNewChat(),
                  child: Container(
                ...
                child: state.sessions.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return _ScaleOnTap(
                            onTap: () =>
                                context.read<CfoAiCubit>().selectSession(s.id),
                            child: Container(
