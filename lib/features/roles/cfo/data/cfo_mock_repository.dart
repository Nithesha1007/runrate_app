...
class CfoMockRepository {
  ...
  Future<String> fetchDailyBriefing() async {
    await Future.delayed(const Duration(milliseconds: 400));
    return 'Spend is tracking 6% under budget this quarter, with Engineering up 14% month over month and three vendor renewals due next month.';
  }
  ...
  Future<List<ChatMessageModel>> fetchSessionMessages(String sessionId) async {
    ...
    final messagesBySession = <String, List<ChatMessageModel>>{
      's1': [
        ...
        ChatMessageModel(
          id: 's1_ai',
          text: 'Q3 spend is tracking 6% under the board-approved budget. Engineering remains the largest cost center at 14% above last month.',
          fromUser: false,
          sentAt: DateTime(2026, 8, 18, 10, 1),
        ),
      ],
      's2': [
        ChatMessageModel(
          ...
          fromUser: true,
          sentAt: DateTime(2026, 8, 17, 14),
        ),
        ChatMessageModel(
          id: 's2_ai',
          text: 'Engineering represents the highest spend at \$182K per month across 38 team members. Spend is up 14% month over month.',
          fromUser: false,
          sentAt: DateTime(2026, 8, 17, 14, 1),
        ),
      ],
      's3': [
        ChatMessageModel(
          ...
          fromUser: true,
          sentAt: DateTime(2026, 8, 16, 9),
        ),
        ChatMessageModel(
          id: 's3_ai',
          text: 'Sales and Marketing have overlapping SaaS tools. Consolidating those subscriptions could save about \$32K this quarter.',
          fromUser: false,
          sentAt: DateTime(2026, 8, 16, 9, 1),
        ),
      ],
      's4': [
        ChatMessageModel(
          ...
          fromUser: true,
          sentAt: DateTime(2026, 8, 13, 11),
        ),
        ChatMessageModel(
          id: 's4_ai',
          text: 'Three approvals are waiting, including the Salesforce renewal for \$54K and AWS Reserved Instances for \$21.5K.',
          fromUser: false,
          sentAt: DateTime(2026, 8, 13, 11, 1),
        ),
      ],
    };
