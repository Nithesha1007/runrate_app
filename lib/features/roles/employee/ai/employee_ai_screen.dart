...
import '../data/employee_mock_repository.dart';
import 'employee_ai_cubit.dart';
import 'employee_ai_state.dart';
...
class EmployeeAiScreen extends StatelessWidget {
 const EmployeeAiScreen({super.key, this.userName = 'Alex'});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => EmployeeAiCubit(EmployeeMockRepository()),
      child: _EmployeeAiView(userName: userName),
    );
  }
}

class _EmployeeAiView extends StatefulWidget {
  const _EmployeeAiView({required this.userName});
  final String userName;

  @override
  State<_EmployeeAiView> createState() => _EmployeeAiViewState();
}

class _EmployeeAiViewState extends State<_EmployeeAiView> {
  final _textController = TextEditingController();
  final _scrollController = ScrollController();

  void _send(BuildContext context, String text) {
    final cubit = context.read<EmployeeAiCubit>();
  ...
  Future<void> _pickImage(BuildContext context) async {
    ...
    context.read<EmployeeAiCubit>().attachFile(result.single.name);
  }
                ...
                children: [
                  Column(
                    children: [
                      _AiHeaderBar(
                        onMenuTap: () =>
                            context.read<EmployeeAiCubit>().openSidebar(),
                        onNewChat: () =>
                            context.read<EmployeeAiCubit>().startNewChat(),
                      ),
                      ...
                      Padding(
                        ...
                        child: _AiInputBar(
                          ...
                          onRemoveAttachment: () =>
                              context.read<EmployeeAiCubit>().removeAttachment(),
                          onMicTap: () =>
                  ...
                  if (state.sidebarOpen)
                    GestureDetector(
                      onTap: () => context.read<EmployeeAiCubit>().closeSidebar(),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: _ScaleOnTap(
                  onTap: () => context.read<EmployeeAiCubit>().startNewChat(),
                  child: Container(
                ...
                child: state.sessions.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return _ScaleOnTap(
                            onTap: () =>
                                context.read<EmployeeAiCubit>().selectSession(s.id),
                            child: Container(
