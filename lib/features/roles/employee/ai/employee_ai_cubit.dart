// employee_ai_cubit.dart
import 'package:flutter_bloc/flutter_bloc.dart';
import '../data/employee_mock_repository.dart';
import '../../../../shared/models/chat_message_model.dart';
import 'package:runrate/features/roles/employee/ai/employee_ai_state.dart';

class EmployeeAiCubit extends Cubit<EmployeeAiState> {
  final EmployeeMockRepository _repo;
  ...
  EmployeeAiCubit(this._repo) : super(const EmployeeAiState()) {
    _loadInsights();
    _loadBriefing();
    _loadSessions();
  }
  ...
  Future<void> sendMessage(String text) async {
    ...
    final List<ChatMessageModel> finalMessages = [...state.messages, reply];
